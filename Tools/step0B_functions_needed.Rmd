...
build_on_BULK_v2<-function(infunc_drugName=DOI[1],
                        infunc_cancerType='PanCan',
                        infunc_featues=featuersNames_bulk_PanCan[[1]],
  ...
  # Train Data:: on bulk
  ##########
  Train_infunc_featues_id=head(na.omit(match(infunc_featues,
                                             rownames(onTarget$expression_rnorm))), k_features)
  Train_features=t(onTarget$expression_rnorm[Train_infunc_featues_id, common_cellLines])
  ...
  Test_infunc_featues_id=head(na.omit(match(infunc_featues,
                                             rownames(onTarget$scRNA_subset_rnorm))), k_features)
  Test_features=t(onTarget$scRNA_subset_rnorm[Test_infunc_featues_id, cell_ID_for_test_data1])
  ...
  cell_ID_for_test_data2=Reduce(intersect,list(cellLines2remove,
                                               ...
                                               names(infunc_response) ))
  Test2_infunc_featues_id=head(na.omit(match(infunc_featues,
                                            rownames(onTarget$expression_rnorm))),
                               k_features)
  Test2_features=t(onTarget$expression_rnorm[Test2_infunc_featues_id,cell_ID_for_test_data2])
  ...
  Test3_infunc_featues_id=head(na.omit(match(infunc_featues,
                                            rownames(onTarget$CPM_scRNA_CCLE_rnorm))),
                               k_features)
  Test3_features=t(onTarget$CPM_scRNA_CCLE_rnorm[Test3_infunc_featues_id,
  ...
  model_for=lapply(1:length(infunc_drugsList),
                     function(x) 
                       err_handle(build_on_BULK_v2(infunc_drugName=infunc_drugsList[x],
                                                infunc_cancerType=id_cancerType,
                                                infunc_featues=rownames(features_fromBulk[[x]]),
