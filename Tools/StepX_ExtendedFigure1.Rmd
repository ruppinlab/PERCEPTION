...
needed_cells_id=match(gsub('-','\\.',lung_tSNE$NAME), colnames(onTarget$CPM_scRNA_CCLE_rnorm))
matched_biomarker_abundance=biomarker_abundance[needed_cells_id]

mdm2_model=readRDS('/Users/sinhas8/Project_scRNAbased_drugCombination/Data/resp_model_nutlin_3.RDS')
